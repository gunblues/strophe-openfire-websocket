// Original file is https://code.google.com/p/openfire-websockets/source/browse/trunk/src/ofchat/js/strophejs/src/strophe-openfire.js
 var Openfire = {};
...
Openfire.Connection.prototype = {
    ...
    {       
        ...
        this.url = this.url + "?username=" + this.username + "&password=" + this.password + "&resource=" + this.resource;
